 ...
 <div class="container">
 	...
 	?>
 	<a href="<?php echo base_url('User/dashboard/').$id_user ?>">Kembali</a>
 	<?php echo form_open("User/edit/".$content->id_content, array('enctype'=>'multipart/form-data')); ?>
